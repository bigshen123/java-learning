package com.bigshen.chatDemoService.design.builder.ResourcePoolBuilder;

/**
 * @Author BYJ
 * @Date 2022/5/6 16:41
 * @Describe 在下面的 ConstructorArg 类中，当 isRef 为 true 的时候，arg 表示 String 类型的 refBeanId，type 不需要设置；
