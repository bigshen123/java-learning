package com.bigshen.learningDemo.javaSE.io.NIO.socketServer;
...
/**
 * @Author BYJ
 * @Date 2024/4/28 21:02
 * @Describe 对 SocketServer1的改进：实际的应用中，为了节约内存资源，我们一般不会为一个通道分配那么多的缓存空间
 */
public class SocketServer2 {
     ...
     * 信息的stringbuffer作为value，存储到服务器端的一个内存区域MESSAGEHASHCONTEXT。
     *
     */
    private static final ConcurrentMap<Integer, StringBuffer> MESSAGE_HASH_CONTEXT = new ConcurrentHashMap<Integer , StringBuffer>();
