package com.bigshen.learningDemo.JUC.pool.taskTreadPool;
...
public class DynamicTask {
    ...
    public void stop(String taskId) {
        ...
        if (ScheduleConfig.cache.get(taskId) == null) {
            return;
        }
    ...
    /**
     自定义任务，这里用来对任务进行封装
     */
    private static class CustomizeTask implements Runnable {
        private final String name;    // 任务名字
        private final String cron;    // 触发条件
