 ...
 * @Describe
 */
public class Vip2Function extends AbstractFunction {

    private static final long serialVersionUID = -8782657886354529640L;
    ...
    public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2, AviatorObject arg3) {
        ...
        if (StringUtils.equals("V2", type)) {
            if (Objects.isNull(bigDecimal)) {
                bigDecimal = BigDecimal.ONE;
            }
            bigDecimal = bigDecimal.multiply(new BigDecimal(year)).multiply(new BigDecimal(20));
